...
const Testimonials = () => {
  return (
    <div className="p-10 bg-slate-700 h-full relative">
      <h1 className="bg-white font-[Karla] text-center text-5xl font-medium">
        Our Stories and Testimonials
      </h1>
      <div className="flex flex-row gap-8 justify-between mt-8 m-10">
        <div className="border flex flex-col justify-center items-center p-6 rounded-md shadow-lg relative">
          <div className="px-6 py-4">
            <p className="text-white text-base">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex
              labore accusamus doloremque praesentium laboriosam sint dolor quis
              doloribus autem. Nobis hic iste exercitationem et, molestiae
              possimus totam unde dolorum! Ipsam?
            </p>
          </div>
          <img
