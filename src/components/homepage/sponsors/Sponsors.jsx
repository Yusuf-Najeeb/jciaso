...
const Sponsors = () => {
  return (
    <div className="flex flex-col px-2 py-4 mt-6 lg:px-10 lg:py-32 lg:gap-16">
      ...
      <section className="flex flex-wrap gap-8 overflow-x-scroll sm:overflow-hidden md:grid sm:grid-cols-3 lg:grid-cols-4 md:gap-4 md:place-content-center md:place-items-center justify-center items-center lg:gap-16 text-semibold text-[1.2rem] p-3 sm:px-8 sm:py-4">
        ...
        <div className="flex flex-col gap-2 items-center">
          <div className=" min-w-[100px] min-h-[100px] bg-white shadow rounded sm:min-w-[300px] max-w-[300px] sm:min-h-[200px] max-h-[200px] grayscale hover:grayscale-0 duration-300 ease-out hover:scale-105 flex justify-center items-center">
            <img
        ...
        <div className="flex flex-col gap-2 items-center">
          <div className=" min-w-[100px] min-h-[100px] bg-white shadow rounded sm:min-w-[300px] max-w-[300px] sm:min-h-[200px] max-h-[250px] grayscale hover:grayscale-0 duration-300 ease-out hover:scale-105 flex justify-center items-center">
            <img
        ...
        <div className="flex flex-col gap-2 items-center">
          <div className=" min-w-[100px] min-h-[100px] bg-white shadow rounded sm:min-h-[200px] max-h-[250px] grayscale hover:grayscale-0 duration-300 ease-out hover:scale-105 flex justify-center items-center">
            <img
