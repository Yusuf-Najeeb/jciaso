  ...
  return (
    <div className=" flex flex-col px-6 py-4 mt-6 lg:px-10 lg:py-32 lg:gap-16 ">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 place-content-center place-items-center justify-center items-center lg:gap-16">
        <div className="flex items-center justify-center bg-white shadow rounded min-w-[300px] max-w-[300px] min-h-[200px] max-h-[250px] hover:scale-110 duration-300">
          <img
            src="https://cdn.hashnode.com/res/hashnode/image/upload/v1708728628410/8b28aa1f-9214-4f69-a711-7ff593898847.png"
            alt="SEC"
            className="grayscale hover:grayscale-0 duration-300 ease-out"
          />
        </div>
        <div className="flex items-center justify-center bg-white shadow rounded min-w-[300px] max-w-[300px] min-h-[200px] max-h-[200px]">
          <img
            src="https://cdn.hashnode.com/res/hashnode/image/upload/v1708729111677/49493e3c-ebf3-4702-a1b0-1f34d4cf7b30.jpeg"
            alt="SamVic"
            className="w-[65%] grayscale hover:grayscale-0 duration-300 ease-out"
          />
        </div>
        <div className="flex items-center justify-center bg-white shadow rounded min-w-[300px] max-w-[300px] min-h-[200px] max-h-[250px] hover:scale-110 duration-300">
          <img
        ...
        <div className="flex items-center justify-center bg-white shadow rounded min-w-[300px] max-w-[300px] min-h-[200px] max-h-[250px] hover:scale-110 duration-300">
          <img
            ...
            alt="Virtusso"
            className="w-[90%] grayscale hover:grayscale-0 duration-300 ease-out"
          />
        </div>
        <div className="flex items-center justify-center bg-white shadow rounded min-w-[300px] max-w-[300px] min-h-[200px] max-h-[250px] hover:scale-110 duration-300">
          <img
            ...
            alt="Studio 24"
            className="w-[70%] grayscale hover:grayscale-0 duration-300 ease-out"
          />
        </div>
        <div className="flex items-center justify-center bg-white shadow rounded min-h-[200px] max-h-[250px] hover:scale-110 duration-300">
          <img
